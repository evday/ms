...
from goods.views import GoodsListSetView,CategoryViewset,BannerViewset,IndexCategoryViewset
...
#配置首页商品系列数据url
rooter.register(r"indexgoods",IndexCategoryViewset,base_name='indexgoods')
urlpatterns = [
